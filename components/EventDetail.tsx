    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <motion.div
          ...
          className="relative mt-8 overflow-hidden rounded-[2rem] border border-[#d8c79f]/40 bg-[#435046] p-8 text-center text-white shadow-[0_15px_50px_rgba(50,60,52,0.12)] sm:p-10"
        >

          {/* Ornamen */}
          <div className="absolute -right-20 -top-20 h-52 w-52 rounded-full border border-[#d4bc8b]/15" />

          <div className="absolute -bottom-24 -left-20 h-60 w-60 rounded-full border border-[#d4bc8b]/10" />
